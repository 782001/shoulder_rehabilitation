...
class StretchScreen extends StatefulWidget {
  ...
  final int id;
  @override
  _StretchScreenState createState() => _StretchScreenState();
}
...
class _StretchScreenState extends State<StretchScreen> {
  // void Submit() {
  //   CashHelper.SaveData(key: 'onStretch', value: true).then((value) {
  //     if (value) {
  //       print('on Stretch save true');
          ...
          if (widget.id == 3) {
            try {
              ...
              repetitionsFromModel = int.parse(
                stretchList6_12[StretchController.page!.round()]
                    .set
  ...
  int currentIndex = 0;
  var StretchController = PageController();
  bool islast = false;
  void onPageChanged(int newIndex) {
    ...
    // Only start a new timer if there is no Stretch timer
    if (!timer.isActive) {
      startTimer();
    }
  }
              ...
              SizedBox(
                ...
                child: PageView.builder(
                    ...
                    onPageChanged: (int index) {
                      ...
                      index == stretchList6_12.length - 1
                          ? setState(() {
                              islast = true;
                            })
                          : setState(() {
                    ...
                    itemBuilder: (context, index) => Build_Stretch_Item(
                          stretchList6_12[index],
                        ),
                    itemCount: stretchList6_12.length),
              ),
              // SizedBox(
  ...
  Widget Build_Stretch_Item(StretchModel model) => SingleChildScrollView(
        child: Column(
...
List<StretchModel> stretchList6_12 = [
  StretchModel(
      image: stretch6_12_1,
      title: "",
      set: "3 set ",
      repetition: "",
      description: "Trunk stretch "),
  StretchModel(
      image: stretch6_12_2,
      title: "",
      set: "3 set ",
      repetition: "",
      description: "Sleeper stretch "),
  StretchModel(
      image: stretch6_12_3,
      title: "",
      set: "3 set ",
      repetition: "",
      description: "Horizontal adduction stretch  "),
  StretchModel(
      image: stretch6_12_4,
      title: "",
      set: "3 set ",
      repetition: "",
      description: "Stretch pectoralis minor  "),
];
