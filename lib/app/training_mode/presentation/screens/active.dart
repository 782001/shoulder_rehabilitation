...
import 'package:shoulder_rehabilitation/app/training_mode/presentation/screens/stretch.dart';
...
class _activeScreenState extends State<activeScreen> {
  // void Submit() {
  //   CashHelper.SaveData(key: 'onactive', value: true).then((value) {
  //     if (value) {
  //       print('on active save true');
          ...
          if (widget.id == 3) {
            try {
              ...
              repetitionsFromModel = int.parse(
                activList6_12[activeController.page!.round()]
                    .set
  ...
  int currentIndex = 0;
  var activeController = PageController();
  bool islast = false;
            ...
            children: [
              ...
              SizedBox(
                ...
                child: PageView.builder(
                    ...
                    itemBuilder: (context, index) => Build_active_Item(
                          activList6_12[index],
                        ),
                    itemCount: activList6_12.length),
              ),
              // SizedBox(
  ...
  Widget Build_active_Item(activeModel model) => SingleChildScrollView(
        child: Column(
...
List<activeModel> activList6_12 = [
  activeModel(
      image: active6_12_1,
      title: "",
      set: "3 set ",
      repetition: "10 repetition ",
      description: "Active shoulder abduction :80-90 degree"),
  activeModel(
      image: active6_12_2,
      title: "",
      set: "3 set ",
      repetition: "10 repetition ",
      description: "Active shoulder external rotation:80-90 degree"),
  activeModel(
      image: active6_12_3,
      title: "",
      set: "3 set ",
      repetition: "10 repetition ",
      description: "Active shoulder internal/medial rotation :70-90 degree"),
  activeModel(
      image: active6_12_4,
      title: "",
      set: "3 set ",
      repetition: "10 repetition ",
      description: "Active shoulder flexion :170-180 degree "),
];
